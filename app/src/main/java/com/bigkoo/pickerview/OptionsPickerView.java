...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private int Color_FirstWheel_FirstRow_Title;
    ...
    public OptionsPickerView(Builder builder) {
        ...
        this.Color_FirstWheel_FirstRow_Title = builder.Color_FirstWheel_FirstRow_Title;
    ...
    public static class Builder {
        ...
        public Builder setFirstWheelFirstRow(int Color) {
            this.Color_FirstWheel_FirstRow_Title = Color;
            return this;
        }
        ...
        public Builder setLabels(String label1, String label2, String label3,String label4) {
            this.label1 = label1;
            this.label2 = label2;
            this.label3 = label3;
            this.label4 = label4;
        ...
        public Builder setCyclic(boolean cyclic1, boolean cyclic2, boolean cyclic3,boolean cyclic4) {
    ...
    public void hideSubmitButton(boolean bHide){
        if(bHide)
    ...
    public void hideCancelButton(boolean bHide){
        if(bHide)
    ...
    public void setSubmitButtonTitle(String astrTitle){
        btnSubmit.setText(astrTitle);
    }
    ...
    private void initView(Context context) {
        ...
        wheelOptions.setCyclic(cyclic1, cyclic2, cyclic3,cyclic4);
    ...
    public void setPicker(List<T> options1Items, List<List<T>> options2Items) {
        wheelOptions.setPicker(options1Items, options2Items, null,null);
        SetCurrentItems();
    }
    ...
    public void setPicker(List<T> options1Items,
        ...
        wheelOptions.setPicker(options1Items, options2Items, options3Items,null);
        SetCurrentItems();
    }
    ...
    public void onClick(View v) {
        ...
        if (tag.equals(TAG_CANCEL)) {
            ...
            if (optionsSelectListener != null) {
                ...
                optionsSelectListener.onOptionsAdd(optionsCurrentItems[0], optionsCurrentItems[1], optionsCurrentItems[2], optionsCurrentItems[3],clickView);
            }
            return;
        }
    }
    ...
    public void returnData() {
        if (optionsSelectListener != null) {
            int[] optionsCurrentItems = wheelOptions.getCurrentItems();
            optionsSelectListener.onOptionsSelect(optionsCurrentItems[0], optionsCurrentItems[1], optionsCurrentItems[2], optionsCurrentItems[3],clickView);
        }
        dismiss();
    }
    ...
    public interface OnOptionsSelectListener {
        ...
        void onOptionsAdd(int options1, int options2, int options3,int options4, View v);
    }
